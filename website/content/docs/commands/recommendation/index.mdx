---
layout: docs
page_title: 'nomad recommendation reference'
description: |
  The `nomad recommendation` command interact with recommendations in Nomad Enterprise. Display a specific recommendation or a list of recommendations. Apply or dismiss recommendations.
---

# `nomad recommendation` reference
