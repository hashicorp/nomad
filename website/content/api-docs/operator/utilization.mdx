...
This endpoint generates a utilization report. If no utilization snapshot has
been recorded in the previous 24 hours, Nomad will record a utilization snapshot
first.
...
API, will decode this to a human-readable file in the current working directory.
