...
description: |-
  Nomad federation enables multiple Nomad clusters, defined as a region, to work together seamlessly. Learn about cross-region request forwarding, replication, and Nomad Enterprise's multi-region job deployments.
---
