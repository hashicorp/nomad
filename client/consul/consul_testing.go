...
type MockConsulClient struct {
	...
	// LastRequestMeta is set by DeriveTokenWithJWT to allow tests to verify
	// the Meta passed in the JWTLoginRequest.
	LastRequestMeta map[string]string
}
