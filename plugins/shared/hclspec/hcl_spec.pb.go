...
func (x *Spec) GetBlock() isSpec_Block {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *Spec) GetObject() *Object {
	if x != nil {
		if x, ok := x.Block.(*Spec_Object); ok {
			return x.Object
		}
	}
	return nil
...
func (x *Spec) GetBlockValue() *Block {
	if x != nil {
		if x, ok := x.Block.(*Spec_BlockValue); ok {
			return x.BlockValue
		}
	}
	return nil
...
func (x *Spec) GetBlockAttrs() *BlockAttrs {
	if x != nil {
		if x, ok := x.Block.(*Spec_BlockAttrs); ok {
			return x.BlockAttrs
		}
	}
	return nil
...
func (x *Spec) GetBlockList() *BlockList {
	if x != nil {
		if x, ok := x.Block.(*Spec_BlockList); ok {
			return x.BlockList
		}
	}
	return nil
...
func (x *Spec) GetBlockSet() *BlockSet {
	if x != nil {
		if x, ok := x.Block.(*Spec_BlockSet); ok {
			return x.BlockSet
		}
	}
	return nil
...
func (x *Spec) GetBlockMap() *BlockMap {
	if x != nil {
		if x, ok := x.Block.(*Spec_BlockMap); ok {
			return x.BlockMap
		}
	}
	return nil
...
func (x *Spec) GetDefault() *Default {
	if x != nil {
		if x, ok := x.Block.(*Spec_Default); ok {
			return x.Default
		}
	}
	return nil
...
func (x *Spec) GetLiteral() *Literal {
	if x != nil {
		if x, ok := x.Block.(*Spec_Literal); ok {
			return x.Literal
		}
	}
	return nil
...
type Object struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Attributes    map[string]*Spec       `protobuf:"bytes,1,rep,name=attributes,proto3" json:"attributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_plugins_shared_hclspec_hcl_spec_proto_rawDesc = "" +
	"\n" +
	"%plugins/shared/hclspec/hcl_spec.proto\x12&hashicorp.nomad.plugins.shared.hclspec\"\x9d\x06\n" +
	"\x04Spec\x12H\n" +
	"\x06object\x18\x01 \x01(\v2..hashicorp.nomad.plugins.shared.hclspec.ObjectH\x00R\x06object\x12E\n" +
	"\x05array\x18\x02 \x01(\v2-.hashicorp.nomad.plugins.shared.hclspec.ArrayH\x00R\x05array\x12B\n" +
	"\x04Attr\x18\x03 \x01(\v2,.hashicorp.nomad.plugins.shared.hclspec.AttrH\x00R\x04Attr\x12P\n" +
	"\vblock_value\x18\x04 \x01(\v2-.hashicorp.nomad.plugins.shared.hclspec.BlockH\x00R\n" +
	"blockValue\x12U\n" +
	"\vblock_attrs\x18\x05 \x01(\v22.hashicorp.nomad.plugins.shared.hclspec.BlockAttrsH\x00R\n" +
	"blockAttrs\x12R\n" +
	"\n" +
	"block_list\x18\x06 \x01(\v21.hashicorp.nomad.plugins.shared.hclspec.BlockListH\x00R\tblockList\x12O\n" +
	"\tblock_set\x18\a \x01(\v20.hashicorp.nomad.plugins.shared.hclspec.BlockSetH\x00R\bblockSet\x12O\n" +
	"\tblock_map\x18\b \x01(\v20.hashicorp.nomad.plugins.shared.hclspec.BlockMapH\x00R\bblockMap\x12K\n" +
	"\adefault\x18\t \x01(\v2/.hashicorp.nomad.plugins.shared.hclspec.DefaultH\x00R\adefault\x12K\n" +
	"\aliteral\x18\n" +
	" \x01(\v2/.hashicorp.nomad.plugins.shared.hclspec.LiteralH\x00R\aliteralB\a\n" +
	"\x05block\"J\n" +
	"\x04Attr\x12\x12\n" +
	...
	"\brequired\x18\x02 \x01(\bR\brequired\x12D\n" +
	"\x06nested\x18\x03 \x01(\v2,.hashicorp.nomad.plugins.shared.hclspec.SpecR\x06nested\"P\n" +
	"\n" +
	"BlockAttrs\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x1a\n" +
	"\brequired\x18\x03 \x01(\bR\brequired\"\x9f\x01\n" +
	"\tBlockList\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tmin_items\x18\x02 \x01(\x04R\bminItems\x12\x1b\n" +
	"\tmax_items\x18\x03 \x01(\x04R\bmaxItems\x12D\n" +
	"\x06nested\x18\x04 \x01(\v2,.hashicorp.nomad.plugins.shared.hclspec.SpecR\x06nested\"\x9e\x01\n" +
	"\bBlockSet\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tmin_items\x18\x02 \x01(\x04R\bminItems\x12\x1b\n" +
	"\tmax_items\x18\x03 \x01(\x04R\bmaxItems\x12D\n" +
	"\x06nested\x18\x04 \x01(\v2,.hashicorp.nomad.plugins.shared.hclspec.SpecR\x06nested\"|\n" +
	"\bBlockMap\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x06labels\x18\x02 \x03(\tR\x06labels\x12D\n" +
	"\x06nested\x18\x03 \x01(\v2,.hashicorp.nomad.plugins.shared.hclspec.SpecR\x06nested\"\x1f\n" +
	"\aLiteral\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\"\x99\x01\n" +
	"\aDefault\x12F\n" +
	"\aprimary\x18\x01 \x01(\v2,.hashicorp.nomad.plugins.shared.hclspec.SpecR\aprimary\x12F\n" +
	"\adefault\x18\x02 \x01(\v2,.hashicorp.nomad.plugins.shared.hclspec.SpecR\adefault\"\xd5\x01\n" +
	"\x06Object\x12^\n" +
	"\n" +
	"attributes\x18\x01 \x03(\v2>.hashicorp.nomad.plugins.shared.hclspec.Object.AttributesEntryR\n" +
	"attributes\x1ak\n" +
...
var (
	...
	file_plugins_shared_hclspec_hcl_spec_proto_rawDescData []byte
)
...
func file_plugins_shared_hclspec_hcl_spec_proto_rawDescGZIP() []byte {
	file_plugins_shared_hclspec_hcl_spec_proto_rawDescOnce.Do(func() {
		file_plugins_shared_hclspec_hcl_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_plugins_shared_hclspec_hcl_spec_proto_rawDesc), len(file_plugins_shared_hclspec_hcl_spec_proto_rawDesc)))
	})
...
func file_plugins_shared_hclspec_hcl_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_plugins_shared_hclspec_hcl_spec_proto_rawDesc), len(file_plugins_shared_hclspec_hcl_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
