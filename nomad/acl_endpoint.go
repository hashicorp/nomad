...
func (a *ACL) UpsertOneTimeToken(args *structs.OneTimeTokenUpsertRequest, reply *structs.OneTimeTokenUpsertResponse) error {
	...
	if !a.srv.peerPartsCache.ServersMeetMinimumVersion(
		a.srv.Region(),
...
func (a *ACL) UpsertRoles(
	...
	if !a.srv.peerPartsCache.ServersMeetMinimumVersion(peer.AllRegions, minACLRoleVersion, false) {
...
func (a *ACL) UpsertAuthMethods(
	...
	if !a.srv.peerPartsCache.ServersMeetMinimumVersion(peer.AllRegions, minACLAuthMethodVersion, false) {
...
func (a *ACL) DeleteBindingRules(
	...
	// ACL binding rules can only be used once all servers in all federated
	// regions have been upgraded to 1.5.0 or greater.
	if !a.srv.peerPartsCache.ServersMeetMinimumVersion(peer.AllRegions, minACLBindingRuleVersion, false) {
...
func (a *ACL) CreateClientIntroductionToken(
	...
	if !a.srv.peerPartsCache.ServersMeetMinimumVersion(a.srv.Region(), minVersionNodeIntro, false) {
		return fmt.Errorf(
