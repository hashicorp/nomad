...
Nomad has performed strenuous benchmark on scalability with [1 million container](https://www.hashicorp.com/c1m) challenge in 2016 and [2 million container challenge](https://www.hashicorp.com/c2m) in 2020. These tests are aimed to validate Nomad's architectural design and ensure that Nomad performs performs under the most extreme for users
