...
path.  The path is relative to the root of the [allocation working
directory]. The path is optional and it defaults to `/` of the allocation
directory.
...
[allocation working directory]: /docs/runtime/environment 'Task Directories'
