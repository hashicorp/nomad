...
### <a name="one-dc"></a>Deployment Topology within One Region
...
### <a name="multi-dc"></a>Deployment Topology within Multiple Regions (Federation)
...
## <a name="system-reqs"></a> System Requirements
