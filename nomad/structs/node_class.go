...
func (n Node) HashInclude(field string, v any) (bool, error) {
	switch field {
...
// included in the computed node class.
func (n Node) HashIncludeMap(field string, k, v any) (bool, error) {
	key, ok := k.(string)
	if !ok {
...
// HashInclude is used to denylist uniquely identifying node fields from being
// included in the computed node class.
func (n NodeResources) HashInclude(field string, v any) (bool, error) {
	switch field {
	case "Devices":
		return true, nil
	default:
...
// HashInclude is used to denylist uniquely identifying node fields from being
// included in the computed node class.
func (n NodeDeviceResource) HashInclude(field string, v any) (bool, error) {
	switch field {
...
// HashIncludeMap is used to denylist uniquely identifying node map keys from being
// included in the computed node class.
func (n NodeDeviceResource) HashIncludeMap(field string, k, v any) (bool, error) {
	key, ok := k.(string)
	if !ok {
		return false, fmt.Errorf("map key %v not a string", k)
	}
