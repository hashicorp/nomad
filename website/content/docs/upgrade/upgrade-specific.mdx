...
1. Add new hosts based on the image.
1. [Drain][drain-cli] and shutdown old Nomad client nodes.
...
[https://github.com/hashicorp/nomad-driver-rkt](https://github.com/hashicorp/nomad-driver-rkt), it will not be maintained as
