...
description: Learn how to use the Virt task driver in your Nomad job specification. Configure a base VM image and set parameters for bootstrapping the VM instance.
---
