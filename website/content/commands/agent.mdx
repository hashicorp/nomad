...
- `-eventlog-logging`: Equivalent to the Event Log [logging][] config option.

- `-eventlog-level`: Equivalent to the Event Log [level][] config option.
...
[level]: /nomad/docs/configuration#eventlog_level
...
[logging]: /nomad/docs/configuration#eventlog_logging
