...
function smallCluster(server) {
  ...
  server.schema.allocations.find(el => el.taskGroup === actionsGroup.name).update({
  ...
  const variableLinkedGroup = server.db.taskGroups.find(el => el.jobId === variableLinkedJob.id);
  const variableLinkedTask = server.db.tasks.find(el => el.taskGroupId === variableLinkedGroup.id);
  [
    'a/b/c/foo0',
    'a/b/c/bar1',
    'a/b/c/d/e/foo2',
