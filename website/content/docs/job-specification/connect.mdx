...
description: |-
  Configure Consul Connect in the `connect` block of the Nomad job specification. Enable Consul service mesh native application integration. Configure sidecar service, sidecar task, and gateway.
---
