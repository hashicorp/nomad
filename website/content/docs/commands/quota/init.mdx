---
layout: docs
page_title: 'nomad quota init reference'
description: |
  The `nomad quota init` generate an example quota specification that you can customize for your Nomad Enterprise quota specification.
---

# `nomad quota init` reference
