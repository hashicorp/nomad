...
description: |-
  Nomad's networking feature enables accessing the information you need to connect your workloads instead of running additional component tools like DNS servers and load balancers. Learn about workload allocation networking and bridge networking, which uses Container Network Interface (CNI) plugins or Docker. Review how Nomad networking differs from Kubernetes networking.
---
