...
description: |-
  Upgrade HashiCorp Nomad without causing an outage. Review the upgrade process for a new version, for moving from Nomad Community to Nomad Enterprise, and for Raft protocol version three.
---
