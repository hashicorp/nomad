...
There are three columns plus comments in this example output, which is for the preceding periodic, parameterized example job. Scroll until the last column for some clarification.
