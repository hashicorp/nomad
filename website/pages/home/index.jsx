...
export default function Homepage() {
  return (
    <div id="p-home">
      ...
      <FeaturesList
        title="Why Nomad?"
        intro="Nomad is widely adopted and used in production by organizations in traditional on-premises datacenters, at the edge, and on the cloud. Learn why users choose Nomad as an <a href='/docs/kubernetes'>alternative to Kubernetes.</a>
        "
        items={[
          {
