...
#### CPU support for amd64 processors

Compiled release binaries for Nomad 1.5 now set [`GOAMD64=v3`][goamd64] at build
time for all amd64 targets. This allows the Go compiler to better optimize for modern
processors made in the past ~10 years. Hardware older than the Intel Haswell or
AMD Excavator series microarchitectures are no longer supported.
...
[goamd64]: https://en.wikipedia.org/wiki/X86-64#Microarchitecture_levels
