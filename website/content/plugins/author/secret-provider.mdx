...
1. Place the binary in the
   [`client.common_plugin_dir/secrets/`][common_plugins_dir] directory on each
   Nomad client node.
...
- Is located in the [`client.common_plugin_dir/secrets/`][common_plugins_dir]
...
That and other information are passed as environment variables.
