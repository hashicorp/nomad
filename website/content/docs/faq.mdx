...
Nomad makes use of both a [consensus protocol](/nomad/docs/architecture/consensus) and
a [gossip protocol](/nomad/docs/architecture/gossip). The consensus protocol is strongly
