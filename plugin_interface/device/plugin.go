...
import (
	...
	bproto "github.com/hashicorp/nomad/plugin-interface/base/proto"
	"github.com/hashicorp/nomad/plugin-interface/device/proto"
...
func (p *PluginDevice) GRPCClient(ctx context.Context, broker *plugin.GRPCBroker, c *grpc.ClientConn) (any, error) {
