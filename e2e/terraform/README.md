...
`terraform.tfvars` file or as a command line argument (ex. `terraform apply -var 'nomad_version=0.10.2+ent'`)

- `nomad_local_binary`: provision this specific local binary of Nomad. This is
  a path to a Nomad binary on your own host. Ex. `nomad_local_binary = "/home/me/nomad"`.
- `nomad_sha`: provision this specific sha from S3. This is a Nomad binary
  ...
  that's pushed to remote. Ex. `nomad_sha = "0b6b475e7da77fed25727ea9f01f155a58481b6c"`
- `nomad_version`: provision this version from
  [releases.hashicorp.com](https://releases.hashicorp.com/nomad). Ex. `nomad_version = "0.10.2+ent"`
