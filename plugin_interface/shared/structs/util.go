...
import (
	...
	"github.com/hashicorp/nomad/plugin-interface/shared/structs/proto"
)
...
func ConvertProtoAttribute(in *proto.Attribute) *Attribute {
	...
	case *proto.Attribute_BoolVal:
		out.Bool = helper.PointerOf(in.GetBoolVal())
	case *proto.Attribute_FloatVal:
		out.Float = helper.PointerOf(in.GetFloatVal())
	case *proto.Attribute_IntVal:
		out.Int = helper.PointerOf(in.GetIntVal())
	case *proto.Attribute_StringVal:
		out.String = helper.PointerOf(in.GetStringVal())
	default:
	}
