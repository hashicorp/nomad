...
proxy managed by Nomad for [Consul Connect](https://learn.hashicorp.com/tutorials/nomad/consul-service-mesh). These
...
[Expose Paths Configuration Reference](https://www.consul.io/docs/connect/registration/service-registration#expose-paths-configuration-reference).
