...
Podman recently released [Podman v2](https://podman.io/blogs/2020/06/29/podman-v2-announce.html). The taskd driver currently supports v1 
...
- `network_mode` - Set the [network mode][network-mode] for the container.
