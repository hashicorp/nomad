...
// UpsertHostVolumes upserts a set of host volume
...
// HostVolumesByNodeID retrieves all ready host volumes on the same node
func (s *StateStore) HostVolumesByNodeID(ws memdb.WatchSet, nodeID string, sort SortOption) (memdb.ResultIterator, error) {
	return s.hostVolumesIter(ws, indexNodeID, sort, nodeID, true)
}

// HostVolumesByNodePool retrieves all ready host volumes on the same node
func (s *StateStore) HostVolumesByNodePool(ws memdb.WatchSet, nodePool string, sort SortOption) (memdb.ResultIterator, error) {
	return s.hostVolumesIter(ws, indexNodePool, sort, nodePool, true)
}
