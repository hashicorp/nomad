  ...
  return (
    <div id="p-home">
      <HomepageHero
        ...
        description="Deploy and manage workloads of any type in the cloud, in a datacenter, or on the edge."
        links={[
          {
            text: 'Download',
            url: '/downloads',
      ...
      <FeaturesList
        ...
        items={[
          {
            title: 'Handles any Workload',
            content: 'Orchestrate applications of any type. Whether you have WASM modules, raw binaries, Firecracker VMs, JAR files, or Docker containers, Nomad can handle it.',
            icon: require('./img/why-nomad/flexible-workload-support.svg'),
          },
          {
            title: 'Scales Globally',
            content: 'Scale without complexity. See how a single Nomad cluster managed fifty million WASM modules and two million containers across the globe in <a href="https://www.hashicorp.com/c2m">the Nomad Challenges</a>.',
            icon: require('./img/why-nomad/federation.svg'),
          },
          {
            title: 'Simple and Lightweight',
            content:
            'Single binary that integrates into existing infrastructure. Easy to operate on-prem, on device, or in the cloud. Nomad is so light that you can run it on a Raspberry Pi with cycles to spare.',
            icon: require('./img/why-nomad/simple-and-lightweight.svg'),
          },
          {
            title: 'REPLACE ME',
            content:
            'Deploy applications globally to any region using Nomad as a single unified control plane.',
      ...
      <div className="use-cases g-grid-container">
        ...
        <UseCases
          ...
          items={[
            {
              title: 'Simple Edge Deployments',
              description: 'Manage millions of workloads across the globe on any type of device, using just a single Nomad cluster.',
              image: {
                alt: null,
                format: 'png',
              ...
              link: {
                external: false,
                title: 'Learn more',
                url: '/use-cases/simple-edge-deployments',
              },
            },
            {
              title: 'Heterogenous Application Orchestration',
              description: 'Run your applications as functions, executables, VMs, or Docker containers.',
              image: {
                alt: null,
                format: 'png',
