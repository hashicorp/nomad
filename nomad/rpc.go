...
func (r *rpcHandler) getLeaderForRPC() (*peer.Parts, error) {
...
func (s *Server) getLeader() (bool, *peer.Parts) {
...
func (r *rpcHandler) forwardLeader(server *peer.Parts, method string, args interface{}, reply interface{}) error {
...
func (r *rpcHandler) forwardServer(server *peer.Parts, method string, args interface{}, reply interface{}) error {
	// Handle a missing server
	if server == nil {
...
func (r *rpcHandler) findRegionServer(region string) (*peer.Parts, error) {
...
func (r *rpcHandler) getServer(region, serverID string) (*peer.Parts, error) {
...
func (r *rpcHandler) streamingRpc(server *peer.Parts, method string) (net.Conn, error) {
