---
layout: docs
page_title: Install and configure the Virt task driver
description: >-
  Install and configure the Virt task driver on your Nomad client.
---

# Install and configure the Virt task driver
...
## Configure the Virt driver as a plugin
