...
[batch-enabled]: /nomad/api-docs/operator#batchschedulerenabled
...
[payload-preemption-config]: /nomad/api-docs/operator#sample-payload-1
[preemption-config]: /nomad/api-docs/operator#preemptionconfig-1
...
[scheduler-configuration]: /nomad/api-docs/operator#read-scheduler-configuration
[service-enabled]: /nomad/api-docs/operator#serviceschedulerenabled-1
...
[update-scheduler]: /nomad/api-docs/operator#update-scheduler-configuration
