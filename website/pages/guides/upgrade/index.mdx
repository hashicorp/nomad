...
description: Learn how to upgrade Nomad.
---
...
safe to do, however we recommend checking the [upgrade specific](/guides/upgrade/upgrade-specific)
...
[specific version details](/guides/upgrade/upgrade-specific) page as some
...
Guide](/guides/operations/node-draining) for instructions on how to migrate running
...
version details](/guides/upgrade/upgrade-specific) page as some version
