...
// Pinned dependencies are explained in github.com/hashicorp/nomad/issues/11826
replace (
...
// The API submodule is intended for use by external clients, Nomad is compiled with
// the current source.
