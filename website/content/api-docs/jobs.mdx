...
- `reverse` `(bool: false)` - Specifies the list of returned jobs should be
  be sorted in the reverse order. By default jobs are returned sorted in
  lexicographical order by their namespace and ID.
