...
description: >-
  Use the Virt task driver in your Nomad jobs to leverage Linux capabilities and to run virtual machines using the libvirt API. Learn about Nomad client requirements, installation, capabilities, and attributes.
---
