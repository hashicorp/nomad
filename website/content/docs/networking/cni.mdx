---
layout: docs
page_title: Configure bridge networking
description: |-
  Learn how to configure Nomad's bridge networking. Install Container Network Interface (CNI) reference plugins and use CNI networks with Nomad jobs.
---
...
clients. You can apply this guide's workflow to installing any network plugin
that complies with the [Container Network Interface (CNI)
Specification][cni-spec], but you should verify plugin compatibility with Nomad
...
[nomad_install]:
    /nomad/tutorials/get-started/get-started-install#linux-post-installation-steps
