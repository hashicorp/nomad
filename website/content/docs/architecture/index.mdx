...
are more details available for each of the sub-systems. The [consensus protocol](/nomad/docs/architecture/consensus),
[gossip protocol](/nomad/docs/architecture/gossip), and [scheduler design](/nomad/docs/concepts/scheduling/how-scheduling-works)
