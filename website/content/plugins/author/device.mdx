...
[DevicePlugin][deviceplugin] interface alongside a main package to launch the
plugin.
...
groups. A device group is a list of detected devices that are identical for the
purpose of scheduling; that is, they have identical attributes.
