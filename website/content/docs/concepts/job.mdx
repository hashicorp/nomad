...
The CLI and API return these
rigid statuses that are useful for scheduling and garbage collection.
However, the Nomad UI displays additional human-readable statuses
to help you manage jobs.
...
- The [job specification](/nomad/docs/job-specification) contains detailed
