...
- [Nomad MCP Server](https://github.com/kocierik/nomad-mcp) - An MCP server that exposes Nomad APIs to AI agents, enabling LLM-driven automation, job management, diagnostics, and cluster operations.
