...
var basicConsulConfig = &config.ConsulConfig{
	Name:                 "default",
...
var basicVaultConfig = &config.VaultConfig{
	Name:                 "default",
	Addr:                 "127.0.0.1:9500",
	AllowUnauthenticated: &trueValue,
...
var basicConfig = &Config{
	...
	Consul:                    basicConsulConfig,
	Consuls: map[string]*config.ConsulConfig{
		"default": basicConsulConfig,
	},
	Vault: basicVaultConfig,
	Vaults: map[string]*config.VaultConfig{
		"default": basicVaultConfig,
	},
...
func (c *Config) addDefaults() {
	...
	if c.Consul == nil {
		...
		c.Consul = config.DefaultConsulConfig().Merge(c.Consul)
		c.Consuls = map[string]*config.ConsulConfig{"default": c.Consul}
	}
	if c.Autopilot == nil {
