...
description: |-
  Use the "server" block to configure the Nomad agent to operate in server mode, which enables participating in scheduling decisions, registering with service discovery, and handling join failures.
---
