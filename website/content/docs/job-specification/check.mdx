...
- `success_before_passing` `(int:0)` - The number of consecutive successful checks
  ...
  Only supported in the Consul service provider. Note: If you are using health checks of type "script," 
  please be aware that the parameter `success_before_passing` is not applicable.
...
- `failures_before_critical` `(int:0)` - The number of consecutive failing checks
  ...
  Only supported in the Consul service provider. Note: If you are using health checks of type "script," 
  please be aware that the parameter `failures_before_critical` is not applicable.
...
- `failures_before_warning` `(int:0)` - The number of consecutive failing checks
  ...
  Only supported in the Consul service provider. Note: If you are using health checks of type "script," 
  please be aware that the parameter `failures_before_warning` is not applicable.
