...
the image defined in [`infra_image`](/nomad/docs/job-declare/task-driver/docker#infra_image) to
...
- [Container Network Interface](/nomad/docs/job-networking/cni) plugins guide
