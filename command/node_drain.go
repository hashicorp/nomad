...
func (c *NodeDrainCommand) Run(args []string) int {
	...
	// Could use either a string or a bool flag?
	// Using a bool first pass
	flags.BoolVar(&reallocate, "reallocate", false, "Reallocate batch job(s)") // current bevahior is true
