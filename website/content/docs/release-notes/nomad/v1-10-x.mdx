...
- [Host volumes section](/nomad/docs/architecture/stateful-workloads#host-volumes)
...
[oidc-concepts]: /nomad/docs/secure/sso/auth-methods/oidc#client-assertions
[oidc-trouble]: /nomad/docs/secure/sso/auth-methods/oidc#oidc-configuration-troubleshooting
