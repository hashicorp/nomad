...
The `tls cert create` command is used to create certificates for your Nomad TLS
setup.
...
==> Using nomad-ca.pem and nomad-ca-key.pem
...
==> Using nomad-ca.pem and nomad-ca-key.pem
==> Saved nomad-client-0.pem
==> Saved nomad-client-0-key.pem
```
...
==> Using nomad-ca.pem and nomad-ca-key.pem
==> Saved nomad-cli-0.pem
==> Saved nomad-cli-0-key.pem
```

## Usage

Usage: `nomad tls cert create [filename-prefix] [options]`
