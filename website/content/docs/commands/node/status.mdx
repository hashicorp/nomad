...
ID        Node Pool  DC   Name   Class   Address   Version  NodeMaxAllocs  Drain  Eligibility  Status  Running Allocs
4d2ba53b  default    dc1  node1  <none>  127.0.0.1  1.10.1   50            false  eligible     ready   1
34dfba32  dev        dc1  node2  <none>  127.0.0.1  1.10.1   50            false  eligible     ready   3
```
