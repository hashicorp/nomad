...
// GetNamespace implements the NamespaceGetter interface, required for filtering
// namespaces in endpoints that support glob namespace requests using tokens with
// limited access.
