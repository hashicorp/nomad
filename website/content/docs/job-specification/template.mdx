...
- `change_script_config` <code>([ChangeScriptConfig][]: nil)</code> - Configures
  the script triggered on template change. This option is required if the
...
[change_script_config]: /docs/job-specification/change_script_config 'Nomad change_script_config Job Specification'
