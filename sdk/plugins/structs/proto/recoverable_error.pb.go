...
// source: sdk/plugins/structs/proto/recoverable_error.proto
...
func init() {
	proto.RegisterFile("sdk/plugins/structs/proto/recoverable_error.proto", fileDescriptor_82d0e8d3a57dbb3c)
}
