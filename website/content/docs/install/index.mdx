...
-> If you are interested in trialing Nomad without installing it locally, see the [Quickstart](/nomad/docs/install/quickstart) for options to get started with Nomad.
...
for Mac OS X. Install the official [Nomad formula](https://github.com/hashicorp/homebrew-tap) from the terminal.
