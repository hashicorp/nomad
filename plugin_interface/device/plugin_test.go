			...
			InstanceStats: map[string]*DeviceStats{
				"1": {
					Summary: &structs.StatValue{
						IntNumeratorVal:   helper.PointerOf(int64(10)),
						IntDenominatorVal: helper.PointerOf(int64(20)),
						Unit:              "MB",
						Desc:              "Unit test",
					},
				},
	...
	devices2 := []*DeviceGroupStats{
		{
			...
			InstanceStats: map[string]*DeviceStats{
				"1": {
					Summary: &structs.StatValue{
						FloatNumeratorVal:   helper.PointerOf(float64(10.0)),
						FloatDenominatorVal: helper.PointerOf(float64(20.0)),
						Unit:                "MB",
						Desc:                "Unit test",
					},
				},
		...
		},
		{
			...
			InstanceStats: map[string]*DeviceStats{
				"1": {
					Summary: &structs.StatValue{
						StringVal: helper.PointerOf("foo"),
						Unit:      "MB",
						Desc:      "Unit test",
					},
				},
