...
## Nomad 1.6.0 Enterprise

#### Enterprise Licenses

Nomad Enterprise 1.6 now compares license `ExpirationTime` with the Nomad binary's `BuildDate`,
...
before trying to upgrade your Enterprise servers to v1.6.
