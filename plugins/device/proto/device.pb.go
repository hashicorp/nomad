...
type DeviceGroup struct {
	...
	// affinities.
	Attributes    map[string]*proto.Attribute `protobuf:"bytes,5,rep,name=attributes,proto3" json:"attributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DeviceGroupStats struct {
	...
	InstanceStats map[string]*DeviceStats `protobuf:"bytes,4,rep,name=instance_stats,json=instanceStats,proto3" json:"instance_stats,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_plugins_device_proto_device_proto_rawDesc = "" +
	"\n" +
	"!plugins/device/proto/device.proto\x12\x1ehashicorp.nomad.plugins.device\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a,plugins/shared/structs/proto/attribute.proto\x1a(plugins/shared/structs/proto/stats.proto\"\x14\n" +
	"\x12FingerprintRequest\"e\n" +
	"\x13FingerprintResponse\x12N\n" +
	"\fdevice_group\x18\x01 \x03(\v2+.hashicorp.nomad.plugins.device.DeviceGroupR\vdeviceGroup\"\x80\x03\n" +
	"\vDeviceGroup\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x1f\n" +
	"\vdevice_type\x18\x02 \x01(\tR\n" +
	"deviceType\x12\x1f\n" +
	"\vdevice_name\x18\x03 \x01(\tR\n" +
	"deviceName\x12H\n" +
	"\adevices\x18\x04 \x03(\v2..hashicorp.nomad.plugins.device.DetectedDeviceR\adevices\x12[\n" +
	"\n" +
	"attributes\x18\x05 \x03(\v2;.hashicorp.nomad.plugins.device.DeviceGroup.AttributesEntryR\n" +
	"attributes\x1ap\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\v21.hashicorp.nomad.plugins.shared.structs.AttributeR\x05value:\x028\x01\"\xba\x01\n" +
	"\x0eDetectedDevice\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\tR\x02ID\x12\x18\n" +
	"\ahealthy\x18\x02 \x01(\bR\ahealthy\x12-\n" +
	"\x12health_description\x18\x03 \x01(\tR\x11healthDescription\x12O\n" +
	"\vhw_locality\x18\x04 \x01(\v2..hashicorp.nomad.plugins.device.DeviceLocalityR\n" +
	"hwLocality\".\n" +
	"\x0eDeviceLocality\x12\x1c\n" +
	"\n" +
	"pci_bus_id\x18\x01 \x01(\tR\bpciBusId\"/\n" +
	"\x0eReserveRequest\x12\x1d\n" +
	"\n" +
	"device_ids\x18\x01 \x03(\tR\tdeviceIds\"l\n" +
	"\x0fReserveResponse\x12Y\n" +
	"\rcontainer_res\x18\x01 \x01(\v24.hashicorp.nomad.plugins.device.ContainerReservationR\fcontainerRes\"\xa8\x02\n" +
	"\x14ContainerReservation\x12R\n" +
	"\x04envs\x18\x01 \x03(\v2>.hashicorp.nomad.plugins.device.ContainerReservation.EnvsEntryR\x04envs\x12=\n" +
	"\x06mounts\x18\x02 \x03(\v2%.hashicorp.nomad.plugins.device.MountR\x06mounts\x12D\n" +
	"\adevices\x18\x03 \x03(\v2*.hashicorp.nomad.plugins.device.DeviceSpecR\adevices\x1a7\n" +
	"\tEnvsEntry\x12\x10\n" +
	...
	"\vpermissions\x18\x03 \x01(\tR\vpermissions\"Z\n" +
	"\fStatsRequest\x12J\n" +
	"\x13collection_interval\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x12collectionInterval\"Y\n" +
	"\rStatsResponse\x12H\n" +
	"\x06groups\x18\x01 \x03(\v20.hashicorp.nomad.plugins.device.DeviceGroupStatsR\x06groups\"\xad\x02\n" +
	"\x10DeviceGroupStats\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12j\n" +
	"\x0einstance_stats\x18\x04 \x03(\v2C.hashicorp.nomad.plugins.device.DeviceGroupStats.InstanceStatsEntryR\rinstanceStats\x1am\n" +
	"\x12InstanceStatsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.hashicorp.nomad.plugins.device.DeviceStatsR\x05value:\x028\x01\"\xde\x01\n" +
	"\vDeviceStats\x12K\n" +
	"\asummary\x18\x01 \x01(\v21.hashicorp.nomad.plugins.shared.structs.StatValueR\asummary\x12H\n" +
	"\x05stats\x18\x02 \x01(\v22.hashicorp.nomad.plugins.shared.structs.StatObjectR\x05stats\x128\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp2\xe2\x02\n" +
	"\fDevicePlugin\x12z\n" +
...
var (
	...
	file_plugins_device_proto_device_proto_rawDescData []byte
)

func file_plugins_device_proto_device_proto_rawDescGZIP() []byte {
	file_plugins_device_proto_device_proto_rawDescOnce.Do(func() {
		file_plugins_device_proto_device_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_plugins_device_proto_device_proto_rawDesc), len(file_plugins_device_proto_device_proto_rawDesc)))
	})
...
func file_plugins_device_proto_device_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_plugins_device_proto_device_proto_rawDesc), len(file_plugins_device_proto_device_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   1,
