...
This key accepts a value of three comma-separated integers:
`xxxx`,`yyyy`,`zzzz`. The first integer indicates the maximum size of the
...
restart of Nomad service will not be sufficient.
