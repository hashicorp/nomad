...
description: |-
 Create a Nomad job file and follow the job workflow to plan, submit, update,
  and run a job.
---
...
section on [inspecting state](/nomad/tutorials/manage-jobs/jobs-inspect)
...
[job update strategies]: /nomad/tutorials/job-updates/job-update-strategies
[inspecting state]: /nomad/tutorials/manage-jobs/jobs-inspect
