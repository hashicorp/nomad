...
func (s *StateStore) Variables(ws memdb.WatchSet) ResultIterator[*structs.VariableEncrypted] {
	txn := s.db.ReadTxn()
	iter := Get[*structs.VariableEncrypted](txn, TableVariables, indexID)
	ws.Add(iter.WatchCh())
	return iter
}
...
func (s *StateStore) GetVariablesByNamespace(
	ws memdb.WatchSet, namespace string) ResultIterator[*structs.VariableEncrypted] {
	txn := s.db.ReadTxn()
	return s.getVariablesByNamespaceImpl(txn, ws, namespace)
}

func (s *StateStore) getVariablesByNamespaceImpl(
	txn *txn, ws memdb.WatchSet, namespace string) ResultIterator[*structs.VariableEncrypted] {
	iter := Get[*structs.VariableEncrypted](txn, TableVariables, indexID+"_prefix", namespace, "")
	ws.Add(iter.WatchCh())
	return iter
}
...
func (s *StateStore) GetVariablesByNamespaceAndPrefix(
	ws memdb.WatchSet, namespace, prefix string) ResultIterator[*structs.VariableEncrypted] {
	txn := s.db.ReadTxn()
	iter := Get[*structs.VariableEncrypted](txn, TableVariables, indexID+"_prefix", namespace, prefix)
	ws.Add(iter.WatchCh())
	return iter
}
...
func (s *StateStore) GetVariablesByPrefix(
	ws memdb.WatchSet, prefix string) ResultIterator[*structs.VariableEncrypted] {
	txn := s.db.ReadTxn()
	iter := Get[*structs.VariableEncrypted](txn, TableVariables, indexPath+"_prefix", prefix)
	ws.Add(iter.WatchCh())
	return iter
}
...
func (s *StateStore) GetVariablesByKeyID(
	ws memdb.WatchSet, keyID string) ResultIterator[*structs.VariableEncrypted] {
	txn := s.db.ReadTxn()
	iter := Get[*structs.VariableEncrypted](txn, TableVariables, indexKeyID, keyID)
	ws.Add(iter.WatchCh())
	return iter
}
...
func (s *StateStore) VariablesQuotas(ws memdb.WatchSet) ResultIterator[*structs.VariablesQuota] {
	txn := s.db.ReadTxn()
	iter := Get[*structs.VariablesQuota](txn, TableVariablesQuotas, indexID)
	ws.Add(iter.WatchCh())
	return iter
}
