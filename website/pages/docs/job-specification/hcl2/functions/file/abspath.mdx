...
Referring directly to filesystem paths in job resources may cause spurious
...
[`file`](/docs/job-specification/hcl2/functions/file) (where only the contents are then
stored).
