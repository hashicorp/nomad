...
- `null`: a value that represents _absence_ or _omission._ If you set an
  argument of a source or module to `null`, Nomad behaves as though you
...
reference](/docs/configuration/job-specification/hcl2/functions).
...
[`flatten`](/docs/configuration/job-specification/hcl2/functions/collection/flatten) and
[`setproduct`](/docs/configuration/job-specification/hcl2/functions/collection/setproduct)
functions.
