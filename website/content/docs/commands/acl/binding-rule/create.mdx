---
layout: docs
page_title: 'nomad acl binding-rule create reference'
description: |
  The `nomad acl binding-rule create` command creates new access control list (ACL) binding rules. Set description, associated authentication method, selector expression, bind name. Configure role, policy, or management bind type.
---

# `nomad acl binding-rule create` reference
