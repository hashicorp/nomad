...
- **[Sentinel Policies](https://learn.hashicorp.com/tutorials/nomad/sentinel)**
  <EnterpriseAlert inline /> - Sentinel policies allow for granular control over
...
- **[Resource Quotas](https://learn.hashicorp.com/tutorials/nomad/quotas)**
  <EnterpriseAlert inline /> - Can limit a namespace's access to the underlying
...
- **[Sentinel Policies](https://learn.hashicorp.com/tutorials/nomad/sentinel)**
  <EnterpriseAlert inline /> - [Sentinel](https://www.hashicorp.com/sentinel/) enables
