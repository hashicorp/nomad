...
type StatObject struct {
	...
	Nested map[string]*StatObject `protobuf:"bytes,1,rep,name=nested,proto3" json:"nested,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// attributes is a mapping of statistic name to its value.
	Attributes    map[string]*StatValue `protobuf:"bytes,2,rep,name=attributes,proto3" json:"attributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_plugins_shared_structs_proto_stats_proto_rawDesc = "" +
	"\n" +
	"(plugins/shared/structs/proto/stats.proto\x12&hashicorp.nomad.plugins.shared.structs\x1a\x1egoogle/protobuf/wrappers.proto\"\xa9\x03\n" +
	"\n" +
	"StatObject\x12V\n" +
	"\x06nested\x18\x01 \x03(\v2>.hashicorp.nomad.plugins.shared.structs.StatObject.NestedEntryR\x06nested\x12b\n" +
	"\n" +
	"attributes\x18\x02 \x03(\v2B.hashicorp.nomad.plugins.shared.structs.StatObject.AttributesEntryR\n" +
	"attributes\x1am\n" +
	"\vNestedEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12H\n" +
	"\x05value\x18\x02 \x01(\v22.hashicorp.nomad.plugins.shared.structs.StatObjectR\x05value:\x028\x01\x1ap\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\v21.hashicorp.nomad.plugins.shared.structs.StatValueR\x05value:\x028\x01\"\xdd\x03\n" +
	"\tStatValue\x12L\n" +
	"\x13float_numerator_val\x18\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\x11floatNumeratorVal\x12P\n" +
	"\x15float_denominator_val\x18\x02 \x01(\v2\x1c.google.protobuf.DoubleValueR\x13floatDenominatorVal\x12G\n" +
	"\x11int_numerator_val\x18\x03 \x01(\v2\x1b.google.protobuf.Int64ValueR\x0fintNumeratorVal\x12K\n" +
	"\x13int_denominator_val\x18\x04 \x01(\v2\x1b.google.protobuf.Int64ValueR\x11intDenominatorVal\x12;\n" +
	"\n" +
...
var (
	...
	file_plugins_shared_structs_proto_stats_proto_rawDescData []byte
)
...
func file_plugins_shared_structs_proto_stats_proto_rawDescGZIP() []byte {
	file_plugins_shared_structs_proto_stats_proto_rawDescOnce.Do(func() {
		file_plugins_shared_structs_proto_stats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_plugins_shared_structs_proto_stats_proto_rawDesc), len(file_plugins_shared_structs_proto_stats_proto_rawDesc)))
	})
...
func file_plugins_shared_structs_proto_stats_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_plugins_shared_structs_proto_stats_proto_rawDesc), len(file_plugins_shared_structs_proto_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
