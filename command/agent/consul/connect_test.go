		...
		require.Equal(t, &api.AgentServiceRegistration{
			...
			Proxy: &api.AgentServiceConnectProxyConfig{
				Config: map[string]interface{}{
					...
					"bind_port":        3000,
					"envoy_stats_tags": []string{"alloc_id=" + allocID},
				},
			},
...
func Test_injectAllocID(t *testing.T) {
	...
	try(
		...
		map[string]interface{}{
			"envoy_stats_tags": []string{"alloc_id=abc123"},
		},
	)
	...
	try(
		...
		map[string]interface{}{
			"foo":              "bar",
			"envoy_stats_tags": []string{"k1=v1", "k2=v2", "alloc_id=abc123"},
		},
	)
	...
	try(
		...
		map[string]interface{}{
			"foo":              "bar",
			"envoy_stats_tags": []string{"k1=v1", "k2=v2", "alloc_id=xyz789"},
		},
		map[string]interface{}{
			"foo":              "bar",
			"envoy_stats_tags": []string{"k1=v1", "k2=v2", "alloc_id=xyz789"},
