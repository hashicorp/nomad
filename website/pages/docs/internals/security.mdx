...
* **[ACLs](https://learn.hashicorp.com/collections/nomad/access-control)** - Allow for
...
[here](https://learn.hashicorp.com/tutorials/nomad/vault-nomad-secrets).
...
* **[Namespaces](https://learn.hashicorp.com/tutorials/nomad/namespace)**
