...
func TestHTTP_JobsList(t *testing.T) {
	...
	httpTest(t, nil, func(s *TestAgent) {
		...
		jobListRequest := models.JobListRequest{}
		jobListRequest.SetNamespace("*")

		jobs, apiResponse, err := client.JobsApi.JobsGetExecute(jobsRequest.JobListRequest(jobListRequest))
		if err != nil {
