...
the `nomad operator raft list-peers` command between server updates to verify
...
[`/v1/operator/autopilot/configuration`]: /nomad/api-docs/operator#read-autopilot-configuration
[`/v1/operator/autopilot/health`]: /nomad/api-docs/operator#read-health
...
[autopilot health]: /nomad/api-docs/operator#read-health
