...
description: Nomad frequently asked questions including checkpoint, gossip and consensus protocols, Nomad datacenter versus Consul datacenter, bootstrapping a cluster, and connecting to a host network using Docker Desktop.
---
