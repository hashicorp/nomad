...
While known for its goal of automating and simplifying application deployment, an orchestrator itself can be extremely complex to implement and manage. Kubernetes requires significant time and deep understanding to deploy, operate, and troubleshoot.

<Callout>

**Teams and organizations choose Nomad as an alternative to Kubernetes for its two core strengths:**
...
<Testimonial
  userLogoUrl="https://via.placeholder.com/210x90"
  userDetails="Canada's #1 cannabis software company migrated off of Kubernetes to Nomad"
>
...
<Testimonial
  userLogoUrl="https://via.placeholder.com/210x90"
  userDetails="Autodesk Research built a scalable, maintenance-free, and multi-cloud orchestration workflow with Nomad"
>
...
<Testimonial
  userLogoUrl="https://via.placeholder.com/210x90"
  userDetails="The top online gaming company built a global gaming platform with Nomad serving more than 150 million players"
>
...
<Testimonial
  userLogoUrl="https://via.placeholder.com/210x90"
  userDetails="The ebanking platform that serves 10% of the digital banking customers in America transformed the deployment workflow with Nomad"
>
