...
- **[Namespaces](/nomad/docs/manage/namespaces)** Access to read
...
- [Namespaces](/nomad/docs/manage/namespaces) This feature
...
| **4648** / TCP + UDP | Servers | [gossip](/nomad/docs/architecture/gossip) protocol to manage server membership using [Serf][serf].                                                                        |
