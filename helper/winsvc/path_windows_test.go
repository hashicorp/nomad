...
func TestCreateDirectory(t *testing.T) {
	...
	t.Run("create unrestricted", func(t *testing.T) {
	...
	t.Run("create restricted", func(t *testing.T) {
		path := filepath.Join(testDir, t.Name())
	...
	t.Run("create unrestricted already exists", func(t *testing.T) {
		path := filepath.Join(testDir, t.Name())
	...
	t.Run("create restricted already exists", func(t *testing.T) {
		path := filepath.Join(testDir, t.Name())
		must.NoError(t, os.MkdirAll(path, 0o000))
