...
Server agents are part of the [consensus protocol](/nomad/docs/architecture/consensus) and
[gossip protocol](/nomad/docs/architecture/gossip). The consensus protocol, powered
...
participate in a [gossip protocol](/nomad/docs/architecture/gossip) both to cluster
...
[consensus]: /nomad/docs/architecture/consensus
