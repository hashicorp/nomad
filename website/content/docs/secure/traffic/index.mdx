...
[enable tls encryption for nomad]: /nomad/docs/secure/transport-security/tls
[enable gossip encryption for nomad]: /nomad/docs/secure/transport-security/gossip-encryption
