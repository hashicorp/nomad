...
When utilizing the High-Availability feature added in v0.4.0, the ACL policy will
need to include capabilities that allow it to obtain and release Nomad variable
...
If running Nomad Autoscaler Enterprise, the following ACL policy addition will be
