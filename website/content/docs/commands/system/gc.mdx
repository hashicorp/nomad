---
layout: docs
page_title: 'nomad system gc reference'
description: |
  The `nomad system gc` run the system garbage collection process on jobs, evaluations, allocations, and nodes.
---

# `nomad system gc` reference
