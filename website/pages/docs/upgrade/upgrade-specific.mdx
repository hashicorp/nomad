...
guide](ttps://learn.hashicorp.com/nomad/operating-nomad/node-draining) for details.
...
[drain-api]:/1/api-docs/nodes#drain-node
...
[preemption-api]:/1/api-docs/operator#update-scheduler-configuration
