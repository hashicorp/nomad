...
These options offer extra security during the OIDC login flow. For a summary, refer to the [Nomad OIDC concepts page](/nomad/docs/secure/authentication/oidc#client).
