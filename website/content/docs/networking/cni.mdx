...
1. [Create a bridge mode configuration](#create-bridge-mode-configuration).
...
Add the [`cni_path`](/nomad/docs/configuration/client#cni_path) and [`cni_config_dir`](/nomad/docs/configuration/client#cni_config_dir) parameters to each client's `client.hcl` file.
