<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>OTEL_RESOURCE_ATTRIBUTES</code>
      </td>
      <td>
        Encoded baggage of OpenTelemetry resource attributes related to Nomad.
        Refer to <a href="/docs/runtime/environment#opentelemetry-resource-attributes">
