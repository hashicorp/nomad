...
func TestAllocEndpoint_List_PaginationFiltering(t *testing.T) {
	...
	mocks := []struct {
		...
		{id: "aaaaaaaa-3350-4b4b-d185-0e1992ed43e9", group: "bar"},             // 3
		{id: "aaaaaabb-3350-4b4b-d185-0e1992ed43e9", group: "goo"},             // 4
		{id: "aaaaaacc-3350-4b4b-d185-0e1992ed43e9"},                           // 5
		{id: "aaaaaadd-3350-4b4b-d185-0e1992ed43e9", group: "bar"},             // 6
		{id: "aaaaaaee-3350-4b4b-d185-0e1992ed43e9", group: "goo"},             // 7
		{id: "aaaaaaff-3350-4b4b-d185-0e1992ed43e9", group: "bar"},             // 8
	}
	...
	cases := []struct {
	...
	}{
		{
			...
			expNextToken: "aaaaaaaa-3350-4b4b-d185-0e1992ed43e9", // next one in default ns
		},
		{
		...
		},
		{
			...
			expNextToken: "aaaaaacc-3350-4b4b-d185-0e1992ed43e9",
			expIDs: []string{
		...
		},
		{
			...
			pageSize:     2,
			expNextToken: "aaaaaaff-3350-4b4b-d185-0e1992ed43e9",
			expIDs: []string{
				"aaaaaaaa-3350-4b4b-d185-0e1992ed43e9",
