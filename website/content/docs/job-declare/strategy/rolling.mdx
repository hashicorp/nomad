...
[service check]: /nomad/docs/job-specification/service#check-parameters
[update-stanza-inheritance]: /nomad/docs/job-specification/update#update-stanza-inheritance
