...
layout: docs
page_title: Glossary
description: "Review Nomad key concepts: allocation, authoritative regions, bin packing, client, datacenters, deployment, driver, evaluation, job, node, node pool, regions, server, task, and task group."
---
