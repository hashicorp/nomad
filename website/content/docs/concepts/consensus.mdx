...
description: |-
  Learn how Nomad uses a consensus protocol based on Raft to manage cluster node state. Topics include logs, Finite State Machine (FSM), peer set, quorum, committed entry, and leader. 
---
