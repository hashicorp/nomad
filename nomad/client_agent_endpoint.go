...
func (a *Agent) forwardFor(serverID, region string) (*peer.Parts, error) {
	var target *peer.Parts
	var err error
...
func (a *Agent) forwardMonitorServer(conn io.ReadWriteCloser, server *peer.Parts, args any, encoder *codec.Encoder, decoder *codec.Decoder, endpoint string) {
...
func (a *Agent) findClientConn(nodeID string) (*nodeConnState, *peer.Parts, error) {
