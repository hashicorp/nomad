...
specific evaluations create allocations, Nomad garbage collects allocations when garbage collecting their evaluations. This also means that Nomad cannot garbage collect
evaluations until their allocations are terminal.
